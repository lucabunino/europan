...
<header onmouseenter={() => menuOpen = true} onmouseleave={() => menuOpen = false}>
  ...
  <nav>
    <ul class="menu" class:off={!menuOpen}>
      <li class="menu-item-container">
        <a class="menu-item" data-item="1" class:off={activeMenuItem && activeMenuItem !== '1'} onmouseenter={(e) => handleMenuEnter(e)} onmouseleave={(e) => handleMenuLeave(e)} href="/sub">Europan 17</a>
      </li>
      <li class="menu-item-container">
        <a class="menu-item" data-item="2" class:off={activeMenuItem && activeMenuItem !== '2'} onmouseenter={(e) => handleMenuEnter(e)} onmouseleave={(e) => handleMenuLeave(e)} href="/sub">Archive</a>
      </li>
      <li class="menu-item-container">
        <a class="menu-item" data-item="3" class:off={activeMenuItem && activeMenuItem !== '3'} onmouseenter={(e) => handleMenuEnter(e)} onmouseleave={(e) => handleMenuLeave(e)} href="/sub">A propos</a>
      </li>
      <li class="menu-item-container">
        <a class="menu-item" data-item="4" class:off={activeMenuItem && activeMenuItem !== '4'} onmouseenter={(e) => handleMenuEnter(e)} onmouseleave={(e) => handleMenuLeave(e)} href="/sub">News</a>
      </li>
      <li class="menu-item-container">
        <a class="menu-item" data-item="5" class:off={activeMenuItem && activeMenuItem !== '5'} onmouseenter={(e) => handleMenuEnter(e)} onmouseleave={(e) => handleMenuLeave(e)} href="/sub">Contact</a>
      </li>
    </ul>
  </nav>
</header>
...
<footer>
  <div>
    <a class="no-hover" target="_blank" href="https://www.bsa-fas.ch/"><img src="/logo/bsafas.webp" alt="bsafas logo"></a>
    <a class="no-hover" target="_blank" href="https://www.bsla.ch/"><img src="/logo/fsap.webp" alt="bsla logo"></a>
    <a class="no-hover" target="_blank" href="https://gvb.ch/"><img src="/logo/gvb.svg" alt="gvb logo"></a>
    <a class="no-hover" target="_blank" href="https://ikea-stiftung.ch/"><img src="/logo/ikea.webp" alt="ikea logo"></a>
